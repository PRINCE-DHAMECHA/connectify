...
const PendingConnection = () => {
  ...
  const getConnections = async () => {
    ...
    try {
      const response = await authFetch.get(`/connection/getAllPending/${id}`, {
  ...
  return (
    <Stack textAlign={"center"} marginTop="30px">
      ...
      >
        {connections
          ?.filter((connection) => connection.person2 === user?._id)
          .map((connection) => (
                      ...
                      <Stack>
                        <Typography fontSize={"1.2rem"}>
                          {connection.person1 === id
                            ...
                            : users[usersIndex[connection.person1]]
                                ?.displayName}
                        </Typography>
                      ...
                      <Stack>
                        ...
                        >
                          {id !== connection.person1
                            ...
                            : users[usersIndex[connection.person2]]
                                ?.displayName}
                        </Typography>
                        <Typography color={"purple"} fontWeight={"bold"}>
                          Your Connection
